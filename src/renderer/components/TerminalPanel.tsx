...
function SortableTab({ tab, isActive, status, shellActivity, showClose, onSelect, onClose, onConvertTabType, editing, onStartEdit, onFinishEdit }: SortableTabProps): JSX.Element {
