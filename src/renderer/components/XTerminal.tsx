...
export function XTerminal({ terminalId, cwd, type, agentKind, visible, sessionName, sessionId, forkFromSessionId, initialPrompt, teleportSessionId, modelOverride, shellCommand, shellCwd, backgroundVar, preamble, hideRestoreNotice, shellBackground, shellCloseDelay, onKeepOpen, onRestartAgent, onSwitchToChat }: XTerminalProps): JSX.Element {
